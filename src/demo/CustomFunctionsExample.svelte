...
<div>
  ...
  <p>
    ...
    Optional function to override the default local filtering that the component
    does based on keyword matching.
    <br />
    The function arguments are individual item from the item list, and the cleaned
    up words from the input field. It should return a boolean indicating wether
    to keep the item.
    <br />
    <br />
    ...
    <br />
    The function arguments are two distincts items from the item list, and the cleaned
    up words from the input field. It should return an integer. If greater than
